...
%token <longValue>   NON_NEGATIVE_LONG
%token <doubleValue> NON_NEGATIVE_DOUBLE
%token MODEL ASIG SEPARATOR LESS_THAN GREATER_THAN
       ...
       BITWISE_LEFT_BY BITWISE_RIGHT_BY AT_SYMBOL
